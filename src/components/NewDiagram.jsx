...
const NewDiagram = () => {
  ...
  useEffect(() => {
    ...
    // Mount paper (only once, after clearing)
    if (paperContainerRef.current) {
      paperContainerRef.current.innerHTML = "";
      paperContainerRef.current.appendChild(paper.el);
      console.log("Paper mounted", paperContainerRef.current);
    }
    ...
    tank1.addTo(graphRef.current);
    panel1.addTo(graphRef.current);
    tank1.embed(panel1);
    ...
    controlValve1.addTo(graphRef.current);
    ...
    controlValve2.addTo(graphRef.current);
    ...
    graphRef.current.addCells([zone1, zone2]);
    ...
    handValve1.addTo(graphRef.current);
    ...
    handValve2.addTo(graphRef.current);
    ...
    handValve3.addTo(graphRef.current);
    ...
    join1.addTo(graphRef.current);

    const join2 = new Join({
      position: { x: 810, y: 605 },
    });

    join2.addTo(graphRef.current);
    ...
    tank1Pipe1.addTo(graphRef.current);
    ...
    tank1Pipe2.addTo(graphRef.current);
    ...
    tank2Pipe1.addTo(graphRef.current);
    ...
    ctrlValve1Pipe1.addTo(graphRef.current);
    ...
    valve2Pipe1.addTo(graphRef.current);
    ...
    valve1Pipe1.addTo(graphRef.current);
    ...
    pump1Pipe1.addTo(graphRef.current);
    ...
    valve3Pipe1.addTo(graphRef.current);
    ...
    pump2Pipe1.addTo(graphRef.current);
    ...
    ctrlValve2Pipe1.addTo(graphRef.current);
    ...
    zone1Pipe1.addTo(graphRef.current);
    ...
    join1Pipe1.addTo(graphRef.current);
    ...
    join2Pipe1.addTo(graphRef.current);
    ...
    tankChart.addTo(graphRef.current);
    ...
    tankChartLink.addTo(graphRef.current);
    ...
    gauge1Link.addTo(graphRef.current);
    ...
    gauge2.addTo(graphRef.current);
    gauge2Link.addTo(graphRef.current);
