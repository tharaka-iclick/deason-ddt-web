...
const BulbView = dia.ElementView.extend({
  ...
  toggleLight() {
    ...
    const anim = this.getGlassAnimation();
    if (anim) anim.playbackRate = state;
  },
});
...
const ElectricalCircuitSimulator: React.FC = () => {
